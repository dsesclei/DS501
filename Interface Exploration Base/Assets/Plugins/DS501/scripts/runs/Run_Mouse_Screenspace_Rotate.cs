...
public class Run_Mouse_Screenspace_Rotate : Base_Run_Rotate
{
	protected Drag_Mouse dragAction = null;
	...
	public override void Start ()
	{
		...
		dragAction = new Drag_Mouse();
		dragAction.register(this.onDrag);
